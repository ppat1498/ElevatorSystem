...
public void sendDestinationRequest(int packetType,int floorNum, int UpDown,int ElevID, int SystemTime)
{
   ...
   byte a[] = new byte[] {(byte)1,(byte)0,(byte)destOrArrival,(byte)0,(byte)floorNo,(byte)0,(byte)UpOrDown,(byte)0,(byte)ID,(byte)0,(byte)Time};
...
public int generateRequest() { 
	...
	System.out.println("Enter the floor Number: %d");
